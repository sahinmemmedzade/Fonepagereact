  ...
  return (
    <header>
        ...
        <div className='navbaricon'>
          {maxWidth <= 1199 ? (
            ...
            <>
              ...
              <MdShoppingBag onClick={toggleSidebar} />
              <IoPerson />
              <FaRegHeart className={wishlist.length > 0 ? "heart-red" : ""} onClick={()=>navigate("/wishlist")}  />
            </>
          )}
        </div>
      </navbar>
      ...
      <div className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
        ...
        <img alt='sebet' src="https://turkmen-sohle.com/wp-content/uploads/2022/09/korzina.png" className='shopsidebarmedium' style={{ display: basket.length > 0 ? 'none' : 'block' }} /> 
